# Projekt-setup prompt för Claude Code

Klistra in detta i ett nytt Claude Code-fönster för att få samma upplägg som Snabbadmin3.
...
- Separat stack-namn, separat nätverk (10.10.25.0/24)
- Bind mount istället för named volume: `./pb_runtime_beta/pb_data:/pb_data`
